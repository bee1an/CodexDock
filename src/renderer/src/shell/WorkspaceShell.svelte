<script lang="ts">
  ...
  import AccountsListView from '../views/accounts/AccountsListView.svelte'
  import AccountsProvidersView from '../views/accounts/AccountsProvidersView.svelte'
  import GroupManagerDialog from '../dialogs/GroupManagerDialog.svelte'
  import AppButton from '$lib/ui/AppButton.svelte'
  import AppButtonGroup from '$lib/ui/AppButtonGroup.svelte'
  import Checkbox from '$lib/ui/Checkbox.svelte'
  import CostStatsView from '../views/stats/CostStatsView.svelte'
  import LocalGatewayView from '../views/gateway/LocalGatewayView.svelte'
  import MotionNumber from '$lib/ui/MotionNumber.svelte'
  import SessionsView from '../views/sessions/SessionsView.svelte'
  import SettingsView from '../views/settings/SettingsView.svelte'
  import SkillsView from '../views/skills/SkillsView.svelte'
  import StashView from '../views/stash/StashView.svelte'
  import { groupMemberCount as groupMemberCountForAccounts } from '../views/accounts/accounts-panel-account'
  import {
  ...
  export let gatewayUsageByAccountId: Record<
    string,
    import('../../../../shared/codex').GatewayUsageSummary
  > = {}
  ...
  export let localGatewayAutoStart = false
  export let updateLocalGatewayAutoStart: (autoStart: boolean) => Promise<void> = async () => {}
...
>
  ...
  {:else if currentView === 'gateway'}
    <LocalGatewayView
      ...
      autoStart={localGatewayAutoStart}
      updateAutoStart={updateLocalGatewayAutoStart}
