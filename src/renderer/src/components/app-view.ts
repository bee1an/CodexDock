...
export const messages = {
  'zh-CN': {
    ...
    trendTooltipModelCount: (count: number) => `${count} 个模型`,
    instanceRunning: '运行中',
    instanceStopped: '已停止',
    instanceTokenPercent: 'Token 占比',
  ...
  en: {
    ...
    trendTooltipModelCount: (count: number) => `${count} model${count === 1 ? '' : 's'}`,
    instanceRunning: 'Running',
    instanceStopped: 'Stopped',
    instanceTokenPercent: 'Token share',
