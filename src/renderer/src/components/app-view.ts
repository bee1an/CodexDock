...
export const messages = {
  'zh-CN': {
    ...
    pasteSessionHint: '粘贴从 chatgpt.com/api/auth/session 获取的 JSON。注意：包含敏感凭证，请勿泄露。',
    ...
    localGatewayOpenCodex: '打开 Codex',
    ...
    localGatewayRoutingTitle: '路由目标',
    localGatewayRoutingHint: '选择请求路由到 Codex 账号池还是直连指定 Provider。',
    localGatewayRoutingModeLabel: '路由模式',
    localGatewayRoutingCodex: 'Codex 账号池',
    localGatewayRoutingProvider: '指定 Provider 直连',
    localGatewayRoutingProviderLabel: '目标 Provider',
    localGatewayRoutingProviderPlaceholder: '请选择 Provider',
  ...
  en: {
    ...
    pasteSessionHint: 'Paste the JSON from chatgpt.com/api/auth/session. Contains sensitive credentials.',
    pasteSessionLabel: 'Session JSON',
    pasteSessionPlaceholder: '{"user":{...},"accessToken":"eyJ...","account":{...}}',
    ...
    localGatewayOpenCodex: 'Open Codex',
    ...
    localGatewayRoutingTitle: 'Routing target',
    localGatewayRoutingHint: 'Choose whether requests route to the Codex account pool or directly to a specific Provider.',
    localGatewayRoutingModeLabel: 'Routing mode',
    localGatewayRoutingCodex: 'Codex account pool',
    localGatewayRoutingProvider: 'Direct Provider',
    localGatewayRoutingProviderLabel: 'Target Provider',
    localGatewayRoutingProviderPlaceholder: 'Select a Provider',
