...
export const messages = {
  ...
  en: {
    ...
    autoWakeTargetGroupCount: (selected: number, total: number) => `${selected}/${total}`,
    autoWakeTargetSelectedCount: (selected: number, total: number) =>
      `Targets ${selected}/${total}`,
    ...
    wakeAllGroupMemberCount: (selected: number, total: number) => `${selected}/${total}`,
    wakeAllSelectedTargetCount: (selected: number, total: number) =>
    ...
    wakeAllSubmitTargetCount: (target: number, selected: number) =>
      `Will wake ${target}/${selected}`,
