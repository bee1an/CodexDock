export const zhMessages = {
  ...
  accountStatusFilter: '账号状态',
  accountStatusFilterAll: '全部状态',
  accountStatusFilterIssues: '异常',
  accountEmailCopy: '复制账号邮箱',
  accountEmailCopied: '已复制',
  accountEmailCopyFailed: '复制失败',
  accountSortByUsage: '按用量排序',
  accountSortPrimaryAsc: '第一窗口剩余额度升序',
  accountSortPrimaryDesc: '第一窗口剩余额度降序',
  accountSortPrimaryResetAsc: '第一窗口最早重置在前',
  accountSortPrimaryResetDesc: '第一窗口最晚重置在前',
  accountSortSecondaryAsc: '第二窗口剩余额度升序',
  accountSortSecondaryDesc: '第二窗口剩余额度降序',
  accountSortSecondaryResetAsc: '第二窗口最早重置在前',
  accountSortSecondaryResetDesc: '第二窗口最晚重置在前',
  ...
  accountProxyDisabledLabel: '禁用本地反代',
  accountProxyEnableLabel: '启用本地反代',
  accountProxyDisabledHint: '开启后即使账号所属分组在本地网关允许列表中，也不会被代理。',
  accountProxyDisabledBadge: '反代已禁用',
